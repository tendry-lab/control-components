...
TEST_CASE("String ops: split: empty value", "[string_ops], [ocs_algo]") {
...
TEST_CASE("String ops: split: invalid delimiter", "[string_ops], [ocs_algo]") {
    TEST_ASSERT_EQUAL(0, StringOps::split('?', "AA:BB:CC:DD:EE:FF").size());
}

TEST_CASE("String ops: split: multiple delimiters", "[string_ops], [ocs_algo]") {
...
TEST_CASE("String ops: split: valid string", "[string_ops], [ocs_algo]") {
