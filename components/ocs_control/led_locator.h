...
private:
    ...
    status::StatusCode add_task_();
    status::StatusCode remove_task_();
    status::StatusCode lock_leds_();
    status::StatusCode unlock_leds_();

    static constexpr core::Time blink_interval_ = core::Duration::second / 2;
    static constexpr core::Time task_interval_ = blink_interval_ * 2;
    static constexpr const char* task_id_ = "led_locator";
