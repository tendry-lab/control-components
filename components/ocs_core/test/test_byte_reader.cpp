...
TEST_CASE("Byte reader: read array: whole at once", "[ocs_core], [byte_reader]") {
    ...
    TEST_ASSERT_EQUAL_UINT32(sizeof(write_buf), reader.get_len());

    uint8_t read_buf[sizeof(write_buf)];
    memset(read_buf, 0, sizeof(read_buf));

    TEST_ASSERT_EQUAL_UINT32(sizeof(write_buf), reader.read(read_buf, sizeof(read_buf)));
...
TEST_CASE("Byte reader: read by offset: whole at once", "[ocs_core], [byte_reader]") {
    ...
    TEST_ASSERT_TRUE(reader.read(byte));
    TEST_ASSERT_EQUAL_UINT8(5, byte);
    TEST_ASSERT_EQUAL_UINT32(sizeof(write_buf) - 1, reader.get_len());
...
TEST_CASE("Byte reader: read by offset: read less", "[ocs_core], [byte_reader]") {
    ...
    TEST_ASSERT_EQUAL_UINT32(sizeof(write_buf) - 2, reader.get_len());

    uint8_t read_buf[sizeof(write_buf)];
    memset(read_buf, 0, sizeof(read_buf));

    TEST_ASSERT_EQUAL_UINT32(sizeof(read_buf) - 2,
                             reader.read(read_buf, sizeof(read_buf)));
    ...
    TEST_ASSERT_EQUAL_UINT32(0, off_reader.get_len());
    TEST_ASSERT_NULL(off_reader.get_data());
}
...
TEST_CASE("Byte reader: discard: less", "[ocs_core], [byte_reader]") {
    ...
    TEST_ASSERT_EQUAL_UINT32(reader.get_len() - 1, reader.discard(reader.get_len() - 1));
    TEST_ASSERT_EQUAL_UINT32(1, reader.get_len());
...
TEST_CASE("Byte reader: discard: more", "[ocs_core], [byte_reader]") {
    ...
    TEST_ASSERT_EQUAL_UINT32(reader.get_len(), reader.discard(reader.get_len() + 1));
    TEST_ASSERT_EQUAL_UINT32(0, reader.get_len());
...
TEST_CASE("Byte reader: discard: all", "[ocs_core], [byte_reader]") {
    ...
    TEST_ASSERT_EQUAL_UINT32(reader.get_len(), reader.discard(reader.get_len()));
    TEST_ASSERT_EQUAL_UINT32(0, reader.get_len());
